                                    ...
                                    controller:
                                      ...
                                      if ((widget.isEdit || widget.itCopy) &&
                                        ...
                                        return 'Консервы/Маринады';
                                          ...
                                          (containerPizzaRecord != null) &&
                                          (containerPizzaRecord.productType == ProductType.cigarettes
                                              ? true
                                              : false)) {
                                        return 'Сигареты';
                                      } else if ((widget.isEdit || widget.itCopy) &&
                                        ...
                                        return 'Море продукты';
                                          ...
                                          (containerPizzaRecord != null) &&
                                          (containerPizzaRecord.productType == ProductType.meat
                                              ? true
                                              : false)) {
                                        return 'Мясо';
                                      } else if ((widget.isEdit || widget.itCopy) &&
                                          (containerPizzaRecord != null) &&
                                          (containerPizzaRecord.productType == ProductType.hardwarestore ? true : false)) {
                                        return 'Хоз товары';
                                ...
                                if (widget.isEdit) {
                                  ...
                                  await PizzaRecord.collection
                                      ...
                                      .set(createPizzaRecordData(
                                        ...
                                        isDeleted: false,
                                        store: editCopyDeletProductStoresRecord
                                            .reference,
                                        barcode: _model
