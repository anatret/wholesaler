...
class ProductDeckPageWidget extends StatefulWidget {
  ...
  final PizzaRecord? documentProduct;
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: ToggleIcon(
                              ...
                              value: FFAppState()
                                  .favorits
                                  .contains(widget.documentProduct?.reference),
                              onIcon: Icon(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            valueOrDefault<String>(
                              widget.documentProduct?.productType?.name,
                              'Категория продукта',
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                          ...
                          Padding(
                            ...
                            child: Text(
                              valueOrDefault<String>(
                                widget.documentProduct?.description,
                                'Описание продукта',
                              ),
                              textAlign: TextAlign.start,
                              style: FlutterFlowTheme.of(context)
