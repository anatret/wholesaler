...
export 'sand_notice_page_model.dart';

class SandNoticePageWidget extends StatefulWidget {
  const SandNoticePageWidget({
    super.key,
    this.productRef,
  });
  ...
  @override
  State<SandNoticePageWidget> createState() => _SandNoticePageWidgetState();
}

class _SandNoticePageWidgetState extends State<SandNoticePageWidget> {
  late SandNoticePageModel _model;
    ...
    return StreamBuilder<List<UserRecord>>(
      stream: queryUserRecord(
        queryBuilder: (userRecord) => userRecord.where(
          'userType',
          isEqualTo: UserTypes.user.serialize(),
        ),
      ),
      builder: (context, snapshot) {
        ...
        List<UserRecord> sandNoticePageUserRecordList = snapshot.data!;
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        TextFormField(
                                          ...
                                          focusNode:
                                              _model.textFieldCardNumFocusNode1,
                                          autofocus: false,
                                        ...
                                        TextFormField(
                                          ...
                                          focusNode:
                                              _model.textFieldCardNumFocusNode2,
                                          autofocus: false,
                                          textCapitalization:
