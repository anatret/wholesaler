...
import '/components/search_empty/search_empty_widget.dart';
                                  ...
                                  child: GridView(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          if (_model.tap ==
                                              ProductType.freezing) {
                                            _model.tap = null;
                                            safeSetState(() {});
                                          } else {
                                            _model.tap = ProductType.freezing;
                                            safeSetState(() {});
                                          }
                                        },
                                        child: Container(
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          if (_model.tap ==
                                            ...
                                            _model.tap = ProductType.seafood;
                                            safeSetState(() {});
                                          }
                                        },
                                        child: Container(
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          if (_model.tap ==
                                            ...
                                            _model.tap = ProductType.babyfood;
                                            safeSetState(() {});
                                          }
                                        },
                                        child: Container(
                                      ...
                                      InkWell(
                                        ...
                                        highlightColor: Colors.transparent,
                                        onTap: () async {
                                          if (_model.tap == ProductType.meat) {
                                            _model.tap = null;
                                            safeSetState(() {});
                                          } else {
                                            _model.tap = ProductType.meat;
                                            safeSetState(() {});
                                          }
                                        },
                                        child: Container(
                                      ...
                                      InkWell(
                                        ...
                                        highlightColor: Colors.transparent,
                                        onTap: () async {
                                          if (_model.tap == ProductType.dairy) {
                                            _model.tap = null;
                                            safeSetState(() {});
                                          } else {
                                            _model.tap = ProductType.dairy;
                                            safeSetState(() {});
                                          }
                                        },
                                        child: Container(
                  ...
                  builder: (context) {
                    if (_model.searchTextFieldTextController.text == '') {
                      return Align(
                        ...
                        child: StreamBuilder<List<PizzaRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<PizzaRecord> staggeredViewPizzaRecordList =
                                snapshot.data!;
                            if (staggeredViewPizzaRecordList.isEmpty) {
                              return const SearchEmptyWidget();
                            }

                            return RefreshIndicator(
                              key: const Key('RefreshIndicator_4599n9z2'),
                              onRefresh: () async {},
                              child: MasonryGridView.builder(
                                ...
                                mainAxisSpacing: 2.0,
                                itemCount: staggeredViewPizzaRecordList.length,
                                shrinkWrap: true,
                                itemBuilder: (context, staggeredViewIndex) {
                                  final staggeredViewPizzaRecord =
                                      staggeredViewPizzaRecordList[
                                          staggeredViewIndex];
                                  return InkWell(
                                    splashColor: Colors.transparent,
                                    focusColor: Colors.transparent,
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      if ((staggeredViewPizzaRecord.inStock ==
                                              true) ||
                                    ...
                                    child: wrapWithModel(
                                      model:
                                          _model.prodGridCardModels1.getModel(
                                        staggeredViewIndex.toString(),
                                        staggeredViewIndex,
                                      ),
                                      updateCallback: () => safeSetState(() {}),
                                      child: ProdGridCardWidget(
                                        key: Key(
                                          'Keyoan_${staggeredViewIndex.toString()}',
                                        ),
                                        productRef:
                                            staggeredViewPizzaRecord.reference,
                                      ),
                                    ),
                                  );
                                },
                      ...
                      return Align(
                        ...
                        child: Builder(
                          builder: (context) {
                            final simpleSearch = _model.simpleSearchResults
                            ...
                            return RefreshIndicator(
                              key: const Key('RefreshIndicator_yu9b2bwa'),
                              onRefresh: () async {},
                              child: MasonryGridView.builder(
                                physics: const NeverScrollableScrollPhysics(),
                                gridDelegate:
                                ...
                                itemBuilder: (context, simpleSearchIndex) {
                                  ...
                                  return InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      if ((simpleSearchItem.inStock == true) ||
                                          ((currentUserDocument?.userType ==
                                                  UserTypes.manager) ||
                                              (currentUserDocument?.userType ==
                                                  UserTypes.admin))) {
                                    ...
                                    child: wrapWithModel(
                                      model:
                                          _model.prodGridCardModels2.getModel(
                                        simpleSearchIndex.toString(),
                                        simpleSearchIndex,
                                      ),
                                      updateCallback: () => safeSetState(() {}),
                                      child: ProdGridCardWidget(
                                        key: Key(
                                          'Keyv4x_${simpleSearchIndex.toString()}',
                                        ),
                                        productRef: simpleSearchItem.reference,
                                      ),
                                    ),
                                  );
                                },
