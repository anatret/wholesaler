                            ...
                            child: StreamBuilder<List<PizzaRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return RefreshIndicator(
                                  key: Key('RefreshIndicator_4599n9z2'),
                                  onRefresh: () async {},
                                  child: MasonryGridView.builder(
                                    ...
                                    mainAxisSpacing: 2.0,
                                    itemCount:
                                        staggeredViewPizzaRecordList.length,
                                    shrinkWrap: true,
                                    itemBuilder: (context, staggeredViewIndex) {
                                      ...
                                      return InkWell(
                                        ...
                                        child: wrapWithModel(
                                          model: _model.prodGridCardModels1
                                              .getModel(
                                          ...
                                          child: ProdGridCardWidget(
                                            ...
                                            productRef: staggeredViewPizzaRecord
                                                .reference,
                                          ),
                                        ),
                                      );
                          ...
                          return Align(
                            ...
                            child: Builder(
                              builder: (context) {
                                ...
                                return RefreshIndicator(
                                  key: Key('RefreshIndicator_yu9b2bwa'),
                                  onRefresh: () async {},
                                  child: MasonryGridView.builder(
                                    physics:
                                        const NeverScrollableScrollPhysics(),
                                    ...
                                    itemBuilder: (context, simpleSearchIndex) {
                                      ...
                                      return InkWell(
                                        ...
                                        child: wrapWithModel(
                                          model: _model.prodGridCardModels2
                                              .getModel(
