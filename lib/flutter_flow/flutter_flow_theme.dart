...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF6803);
  late Color secondary = const Color(0xFFCF5C36);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE7E7E7);
  ...
  late Color accent4 = const Color(0xFFCECECE);
