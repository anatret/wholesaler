...
import 'f_a_b_whole_store_page_model.dart';
export 'f_a_b_whole_store_page_model.dart';

class FABWholeStorePageWidget extends StatefulWidget {
  const FABWholeStorePageWidget({
    super.key,
  ...
  @override
  State<FABWholeStorePageWidget> createState() =>
      _FABWholeStorePageWidgetState();
}

class _FABWholeStorePageWidgetState extends State<FABWholeStorePageWidget>
    with TickerProviderStateMixin {
  late FABWholeStorePageModel _model;
